...
from .views import ClienteView,ClienteNew,ClienteEdit,clienteInactivar,FacturaView,facturaRealizar,ProductoView,borrar_detalle_factura
...
urlpatterns = [
    ...
    path('facturas/new', facturaRealizar, name='factura_new'),
    path('facturas/edit/<int:id>', facturaRealizar, name='factura_edit'),
